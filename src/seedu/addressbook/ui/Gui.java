...
public class Gui {
    ...
    /** file path for application icon */
    public static final String PATH_APPLICATION_ICON = "file:doc/images/book-icon.png";
    ...
    private MainWindow createMainWindow(Stage stage, Stoppable mainApp) throws IOException{
        ...
        stage.getIcons().add(new Image(PATH_APPLICATION_ICON));
        stage.show();
